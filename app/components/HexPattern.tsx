// דפוס משושים אחיד (honeycomb) הניתן לשימוש חוזר. הצבע נקבע ע"י currentColor
// (כלומר ע"י text-color של ה-svg). id ייחודי נדרש כדי שכמה מופעים יוכלו להופיע באותו דף.
